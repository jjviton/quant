...
def analisisENTRADA(instrumento, startt, endd, df):    #analisis_v2
    ...
    la banda de boulinger inferior entrar.
...
if __name__ == '__main__':    
    ...
    regreMedia= StrategyClass(real_back=False)    #Creamos la clase
    
    if(TELEGRAM__):
        telegram_send("2.- Estrategia Regresion a la media V2.2\n ")
    ...
    for i in range(len(sp)):
         ...
         print(symbol)
         regreMedia.analisis(symbol, start, end, dfe )
         #time.sleep (1)
