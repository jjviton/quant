...
def analisisENTRADA(instrumento, startt, endd, df):    #analisis_v2
    ...
    df['y']= df.Close.shift(-5)        # ponemos la condicon del valor de la accion en 10 dias (ejemplo para empezar)
    ...
    print("Precio de cierra para 5sesiones depues de la fecha",y_pred_last)
    ...
    dfx.plot(title='Random Forest',color=colors)
